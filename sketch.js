...
function spawnClouds() {
  ...
  if (frameCount % 200 === 0) {
    cloud = createSprite(795,100,40,10);
...
function spawnP1(){
  if(frameCount % 97  === 0){
     P1 = createSprite(795,height-120,10,10);
...
function spawnP2(){
  if(frameCount % 257  === 0){
     P2 = createSprite(795,height-120,10,10);
...
function spawnP3(){
  if(frameCount % 441  === 0){
     P3 = createSprite(795,height-120,10,10);
...
function spawnP4(){
  if(frameCount % 563  === 0){
     P4 = createSprite(795,height-140,10,10);
